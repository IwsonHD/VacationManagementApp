...
namespace VacationManagementApp.Migrations
{
    ...
    [Migration("20230903150050_EmployeeConfirmationUpdate")]
    partial class EmployeeConfirmationUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacationManagementApp.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VacationManagementApp.Models.Employer", b =>
                {
                    b.HasBaseType("VacationManagementApp.Models.User");
            ...
            modelBuilder.Entity("VacationManagementApp.Models.Employee", b =>
                {
                    b.HasOne("VacationManagementApp.Models.User", null)
                        .WithOne()
                        .HasForeignKey("VacationManagementApp.Models.Employee", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
